            ...
            <div className="backdrop-blur-md bg-white/70 rounded-2xl border border-white/20 shadow-xl p-6 hover:shadow-2xl transition-all duration-300 hover:scale-[1.01]">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  <button className="p-2 bg-white/50 hover:bg-white/80 rounded-lg text-gray-600 transition-colors">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="backdrop-blur-md bg-white/70 rounded-2xl border border-white/20 shadow-xl p-6 hover:shadow-2xl transition-all duration-300 hover:scale-[1.01]">
                ...
                <div className="space-y-4">
                    ...
                    <button className="w-full mt-2 py-3 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 transition-colors flex items-center justify-center gap-2">
