...
const Hostel = () => {
  ...
  const QuickActionCard = ({ icon: Icon, title, description, color }) => (
    <button className={`p-4 bg-white/50 hover:bg-white/70 rounded-lg transition-all duration-200 hover:scale-105 flex items-center gap-4 border-2 border-transparent hover:border-${color}-200`}>
            ...
            <div className="lg:col-span-1 space-y-6">
                ...
                <div className="backdrop-blur-md bg-white/70 rounded-2xl border border-white/20 shadow-xl p-6 hover:shadow-2xl transition-all duration-300 hover:scale-[1.01]">
                    ...
                    <div className="space-y-3">
                       <QuickActionCard icon={Wrench} title="Maintenance Request" description="Report an issue in your room." color="blue" />
                       <QuickActionCard icon={ClipboardCheck} title="Apply for Gate Pass" description="Request for overnight leave." color="purple" />
                       <QuickActionCard icon={Info} title="Rules & Regulations" description="Read the hostel guidelines." color="green" />
                    </div>
                </div>
