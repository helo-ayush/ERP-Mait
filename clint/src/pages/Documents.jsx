...
const Documents = () => {
  ...
  const ActionButtons = ({ doc }) => {
    switch (doc.status) {
      ...
      case 'Pending':
        return (
          <button className="p-2 bg-white/60 hover:bg-white/90 text-sm font-semibold text-gray-800 rounded-lg transition-colors flex items-center gap-2">
      ...
      case 'Rejected':
        return (
          <div className="flex items-center gap-2">
            ...
            <button className="p-2 bg-blue-500 hover:bg-blue-600 text-sm font-semibold text-white rounded-lg transition-colors flex items-center gap-2">
